...
function addressSearch() {
    ...
    $.when($.getJSON(INFO_API, params)).then(function(data){
        ...
        if (divisions === undefined) {
            ...
            $("#address-image").html("<img class='img-responsive img-thumbnail' src='https://maps.googleapis.com/maps/api/staticmap?size=600x200&maptype=roadmap&markers=" + encodeURIComponent(address) + "&key=" + API_KEY + "' alt='" + address + "' title='" + address + "' />");
